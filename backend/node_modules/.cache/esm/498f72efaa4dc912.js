let fs,jwt,AsyncLock,InputError,AccessError;_aa4‍.x([["save",()=>save],["reset",()=>reset],["assertValidUserId",()=>assertValidUserId],["getUserIdFromAuthorization",()=>getUserIdFromAuthorization],["getUserIdFromEmail",()=>getUserIdFromEmail],["login",()=>login],["register",()=>register],["assertValidJobPost",()=>assertValidJobPost],["assertCreatorOfJobPost",()=>assertCreatorOfJobPost],["assertWatcherOfJobPost",()=>assertWatcherOfJobPost],["getJobs",()=>getJobs],["postJob",()=>postJob],["updateJobPost",()=>updateJobPost],["commentOnJobPost",()=>commentOnJobPost],["likeJobPost",()=>likeJobPost],["deleteJobPost",()=>deleteJobPost],["getUser",()=>getUser],["watchUser",()=>watchUser],["updateProfile",()=>updateProfile]]);_aa4‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_aa4‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_aa4‍.w("async-lock",[["default",["AsyncLock"],function(v){AsyncLock=v}]]);_aa4‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);
